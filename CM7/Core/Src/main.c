...
static void MX_ADC2_Init(void)
{
  ...
  */
  ...
  hadc2.Init.ExternalTrigConv = ADC_EXTERNALTRIG_HR1_ADCTRG3;
...
static void MX_HRTIM_Init(void)
{
  ...
  if (HAL_HRTIM_ADCTriggerConfig(&hhrtim, HRTIM_ADCTRIGGER_3, &pADCTriggerCfg) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = (HAL_RCC_GetPCLK1Freq() / 1000000 * 2) - 1;
...
static void MX_TIM7_Init(void)
{
  ...
  htim7.Instance = TIM7;
  htim7.Init.Prescaler = (HAL_RCC_GetPCLK1Freq() / 1000000 * 2) - 1;
...
static void MX_DMA_Init(void)
{
  ...
  HAL_NVIC_SetPriority(DMA1_Stream0_IRQn, NVIC_PRIO_UART1_DMA_RX, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream0_IRQn);
  /* DMA1_Stream1_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Stream1_IRQn, NVIC_PRIO_UART1_DMA_TX, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream1_IRQn);
  /* DMA1_Stream2_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Stream2_IRQn, NVIC_PRIO_ADC2_DMA, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream2_IRQn);
  /* DMA1_Stream4_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Stream4_IRQn, NVIC_PRIO_UART3_DMA_RX, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream4_IRQn);
  /* DMA1_Stream5_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Stream5_IRQn, NVIC_PRIO_UART3_DMA_TX, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream5_IRQn);
  /* DMA1_Stream6_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA1_Stream6_IRQn, NVIC_PRIO_ADC1_DMA, 0);
  HAL_NVIC_EnableIRQ(DMA1_Stream6_IRQn);
  /* DMA2_Stream1_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA2_Stream1_IRQn, NVIC_PRIO_DMA_M2M_1, 0);
  HAL_NVIC_EnableIRQ(DMA2_Stream1_IRQn);
  /* DMA2_Stream2_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA2_Stream2_IRQn, NVIC_PRIO_DMA_M2M_2, 0);
  HAL_NVIC_EnableIRQ(DMA2_Stream2_IRQn);
  /* DMA2_Stream3_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA2_Stream3_IRQn, NVIC_PRIO_DMA_M2M_3, 0);
  HAL_NVIC_EnableIRQ(DMA2_Stream3_IRQn);
  /* DMA2_Stream4_IRQn interrupt configuration */
  HAL_NVIC_SetPriority(DMA2_Stream4_IRQn, NVIC_PRIO_DMA_M2M_4, 0);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, OUTS1_IN9_Pin|OUTS1_IN10_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SPI6_NSS_TCS1_Pin|SPI6_NSS_TCS2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IGN_NEN_Pin|MOTOR1_DIS_Pin|MOTOR2_DIS_Pin|SPI3_NSS_FLEXIO2_Pin
                          |SPI6_NSS_KNOCK_Pin|OUTS1_IN11_Pin|OUTS1_IN12_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, SPI5_NSS_OUTSM1_Pin|SPI5_NSS_OUTSM2_Pin|SPI5_NSS_OUTS1_Pin|SPI5_NSS_OUTS2_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, STEP_I0_Pin|STEP_I1_Pin|STEP_PH1_Pin|STEP_PH2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, FLEXIO1_SYNC_Pin|FLEXIO2_SYNC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LAMBDA_HEATER_NEN_Pin FLEXIO1_SYNC_Pin FLEXIO2_SYNC_Pin */
  GPIO_InitStruct.Pin = LAMBDA_HEATER_NEN_Pin|FLEXIO1_SYNC_Pin|FLEXIO2_SYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : LOGIC_OE_Pin */
  ...
  /*Configure GPIO pins : IGN_CH5_Pin IGN_CH6_Pin IGN_CH7_Pin IGN_CH8_Pin
                           MOTOR1_DIR_Pin MOTOR2_DIR_Pin IGN_CH1_Pin IGN_CH2_Pin
                           IGN_CH3_Pin IGN_CH4_Pin */
  GPIO_InitStruct.Pin = IGN_CH5_Pin|IGN_CH6_Pin|IGN_CH7_Pin|IGN_CH8_Pin
                          |MOTOR1_DIR_Pin|MOTOR2_DIR_Pin|IGN_CH1_Pin|IGN_CH2_Pin
                          |IGN_CH3_Pin|IGN_CH4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : OUTS1_IN9_Pin OUTS1_IN10_Pin */
  GPIO_InitStruct.Pin = OUTS1_IN9_Pin|OUTS1_IN10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI6_NSS_TCS1_Pin SPI6_NSS_TCS2_Pin */
  GPIO_InitStruct.Pin = SPI6_NSS_TCS1_Pin|SPI6_NSS_TCS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : IGN_NEN_Pin */
  GPIO_InitStruct.Pin = IGN_NEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IGN_NEN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI5_NSS_OUTSM1_Pin SPI5_NSS_OUTSM2_Pin SPI5_NSS_OUTS1_Pin SPI5_NSS_OUTS2_Pin
                           SPI6_NSS_LAMBDA1_Pin OUTS_RESET_Pin SPI6_NSS_LAMBDA2_Pin */
  GPIO_InitStruct.Pin = SPI5_NSS_OUTSM1_Pin|SPI5_NSS_OUTSM2_Pin|SPI5_NSS_OUTS1_Pin|SPI5_NSS_OUTS2_Pin
                          |SPI6_NSS_LAMBDA1_Pin|OUTS_RESET_Pin|SPI6_NSS_LAMBDA2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pins : FLEXIO1_INT_Pin FLEXIO2_INT_Pin */
  GPIO_InitStruct.Pin = FLEXIO1_INT_Pin|FLEXIO2_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : MOTOR1_DIS_Pin MOTOR2_DIS_Pin SPI3_NSS_FLEXIO2_Pin SPI6_NSS_KNOCK_Pin
                           OUTS1_IN11_Pin OUTS1_IN12_Pin */
  GPIO_InitStruct.Pin = MOTOR1_DIS_Pin|MOTOR2_DIS_Pin|SPI3_NSS_FLEXIO2_Pin|SPI6_NSS_KNOCK_Pin
                          |OUTS1_IN11_Pin|OUTS1_IN12_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pin : USART3_LO_Pin */
  GPIO_InitStruct.Pin = USART3_LO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(USART3_LO_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : FLEXIO2_WAKE_Pin */
  GPIO_InitStruct.Pin = FLEXIO2_WAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(FLEXIO2_WAKE_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : FLEXIO2_SENT1_Pin FLEXIO2_SENT2_Pin FLEXIO2_SENT3_Pin FLEXIO2_SENT4_Pin */
  GPIO_InitStruct.Pin = FLEXIO2_SENT1_Pin|FLEXIO2_SENT2_Pin|FLEXIO2_SENT3_Pin|FLEXIO2_SENT4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : LAMBDA_NRST_Pin */
  GPIO_InitStruct.Pin = LAMBDA_NRST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LAMBDA_NRST_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : FDCAN1_LBK_Pin */
  GPIO_InitStruct.Pin = FDCAN1_LBK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(FDCAN1_LBK_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : STEP_I0_Pin STEP_I1_Pin STEP_PH1_Pin STEP_PH2_Pin
                           SPI2_NSS_FLEXIO1_Pin */
  GPIO_InitStruct.Pin = STEP_I0_Pin|STEP_I1_Pin|STEP_PH1_Pin|STEP_PH2_Pin
                          |SPI2_NSS_FLEXIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  HAL_NVIC_SetPriority(EXTI9_5_IRQn, NVIC_PRIO_EXTI_5_9, 0);
  HAL_NVIC_EnableIRQ(EXTI9_5_IRQn);

  HAL_NVIC_SetPriority(EXTI15_10_IRQn, NVIC_PRIO_EXTI_10_15, 0);
