...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_SENT1_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_SENT2_Pin);
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_SENT3_Pin);
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_SENT4_Pin);
  HAL_GPIO_EXTI_IRQHandler(FLEXIO1_WAKE_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_WAKE_Pin);
  HAL_GPIO_EXTI_IRQHandler(FLEXIO1_INT_Pin);
  HAL_GPIO_EXTI_IRQHandler(FLEXIO2_INT_Pin);
