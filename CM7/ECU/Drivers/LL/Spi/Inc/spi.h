...
#ifndef DRIVERS_LL_SPI_INC_SPI_H_
#define DRIVERS_LL_SPI_INC_SPI_H_
...
typedef struct spi_slave_tag {
  ...
  bool prescaler_configured;
  bool datasize_configured;
...
error_t spi_configure_flush_config(spi_cfg_t *spi_cfg);
...
#endif /* DRIVERS_LL_SPI_INC_SPI_H_ */
