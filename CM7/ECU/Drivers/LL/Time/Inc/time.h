...
#ifndef DRIVERS_LL_TIME_INC_TIME_H_
#define DRIVERS_LL_TIME_INC_TIME_H_
...
typedef struct {
    ...
    time_delta_tick_t load_tick_last;
    time_delta_tick_t load_tick_min;
    time_delta_tick_t load_tick_max;
}time_msmnt_item_t;
...
#endif /* DRIVERS_LL_TIME_INC_TIME_H_ */
