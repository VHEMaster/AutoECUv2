...
#ifndef DRIVERS_LL_OUTPUTS_INC_OUTPUTS_INTERNAL_H_
#define DRIVERS_LL_OUTPUTS_INC_OUTPUTS_INTERNAL_H_
...
typedef struct {
    ...
    output_ch_ctx_t *channels[OUTPUTS_CHS_MAX];
}output_ch_poll_ctx_t;
...
typedef struct {
    ...
    output_ch_poll_ctx_t poll[OUTPUT_POLLING_MODE_MAX];
...
#endif /* DRIVERS_LL_OUTPUTS_INC_OUTPUTS_INTERNAL_H_ */
