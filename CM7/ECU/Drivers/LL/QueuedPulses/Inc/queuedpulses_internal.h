...
#ifndef DRIVERS_LL_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_
#define DRIVERS_LL_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_
...
#endif /* DRIVERS_LL_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_ */
