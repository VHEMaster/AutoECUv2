...
#ifndef ECU_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_
#define ECU_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_
...
#endif /* ECU_QUEUEDPULSES_INC_QUEUEDPULSES_INTERNAL_H_ */
