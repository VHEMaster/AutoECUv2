...
static void calcdata_sensor_read_ect(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_egt(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_iat(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_maf(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_map(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_ops(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_ots(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_tps(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
static void calcdata_sensor_read_vss(ecu_core_ctx_t *ctx, ecu_sensor_instance_t instance, void *userdata, ecu_core_runtime_value_ctx_t *result);
