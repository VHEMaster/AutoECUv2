...
typedef struct {
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_aps[ECU_CONFIG_IO_APS_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_ect[ECU_CONFIG_IO_ECT_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_ckp[ECU_CONFIG_IO_CKP_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_ops[ECU_CONFIG_IO_OPS_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_ots[ECU_CONFIG_IO_OTS_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_vss[ECU_CONFIG_IO_VSS_MAX];
...
typedef struct {
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_cmp[ECU_CONFIG_IO_CMP_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_egt[ECU_CONFIG_IO_EGT_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_iat[ECU_CONFIG_IO_IAT_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_maf[ECU_CONFIG_IO_MAF_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_map[ECU_CONFIG_IO_MAP_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *sensors_tps[ECU_CONFIG_IO_TPS_MAX];

    const ecu_core_runtime_global_instance_parameters_ctx_t *devices_stepper[ECU_CONFIG_IO_STEPPER_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *devices_wbls[ECU_CONFIG_IO_WBLS_MAX];

    const ecu_core_runtime_global_instance_parameters_ctx_t *modules_etc[ECU_CONFIG_IO_ETC_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *modules_vvt[ECU_CONFIG_IO_VVT_MAX];
    const ecu_core_runtime_global_instance_parameters_ctx_t *modules_wgcv[ECU_CONFIG_IO_WGCV_MAX];
