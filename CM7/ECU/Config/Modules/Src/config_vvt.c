...
static RAM_SECTION ecu_modules_vvt_ctx_t ecu_modules_vvt_ctx[ECU_MODULE_VVT_MAX] = {
    {
      .init = {
...
error_t ecu_modules_vvt_init(ecu_module_vvt_t instance, vvt_ctx_t *ctx)
{
  ...
  do {
    BREAK_IF_ACTION(instance >= ECU_MODULE_VVT_MAX || ctx == NULL, err = E_PARAM);
...
error_t ecu_modules_vvt_get_default_config(ecu_module_vvt_t instance, vvt_config_t *config)
{
  ...
  do {
    BREAK_IF_ACTION(instance >= ECU_MODULE_VVT_MAX || config == NULL, err = E_PARAM);
...
error_t ecu_modules_vvt_reset(ecu_module_vvt_t instance)
{
  ...
  do {
    BREAK_IF_ACTION(instance >= ECU_MODULE_VVT_MAX, err = E_PARAM);
