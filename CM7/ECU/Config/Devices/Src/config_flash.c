...
static RAM_SECTION ecu_devices_flash_ctx_t ecu_devices_flash_ctx[ECU_DEVICE_FLASH_MAX] = {
    {
        .init = &ecu_devices_flash_init_ctx[ECU_DEVICE_FLASH_1],
    }
};
