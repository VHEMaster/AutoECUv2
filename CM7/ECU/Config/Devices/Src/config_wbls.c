...
static const cj125_config_t ecu_devices_wbls_config_default = {
    ...
    // LSU ADV
    .curr_to_lambda_relation = {
        .input = { -1.38f, -1.11f, -0.88f, -0.65f, -0.475f, -0.37f, -0.30f, -0.16f, -0.076f, -0.048f, -0.020f, 0.01167f, 0.03278f, 0.06444f, 0.08556f, 0.17f, 0.2308f, 0.36f, 0.40148f, 0.52f, 0.5474f, 0.77f, 1.4f },
        .output = { 0.65f, 0.70f, 0.75f, 0.80f, 0.85f, 0.88f, 0.90f, 0.95f, 0.98f, 0.99f, 1.00f, 1.03f, 1.05f, 1.08f, 1.10f, 1.18f, 1.26f, 1.43f, 1.50f, 1.70f, 1.78f, 2.43f, 5.00f },
        .items = 23,
    },
    */
