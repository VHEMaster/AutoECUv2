...
typedef enum {
  ...
  ECU_CONFIG_TABLE_2D_32X32_END = ECU_CONFIG_TABLE_2D_32X32_15,

  ECU_CONFIG_TABLE_2D_16X16_START,
  ...
  ECU_CONFIG_TABLE_2D_16X16_END = ECU_CONFIG_TABLE_2D_16X16_15,

  ECU_CONFIG_TABLE_2D_8X8_START,
  ...
  ECU_CONFIG_TABLE_2D_8X8_END = ECU_CONFIG_TABLE_2D_8X8_7,


  ECU_CONFIG_TABLE_1D_32_START,
  ...
  ECU_CONFIG_TABLE_1D_32_END = ECU_CONFIG_TABLE_1D_32_15,

  ECU_CONFIG_TABLE_1D_16_START,
  ...
  ECU_CONFIG_TABLE_1D_16_END = ECU_CONFIG_TABLE_1D_16_15,

  ECU_CONFIG_TABLE_1D_8_START,
  ...
  ECU_CONFIG_TABLE_1D_8_END = ECU_CONFIG_TABLE_1D_8_15,
}ecu_config_tables_table_index_t;

#define ECU_CONFIG_TABLES_2D_32X32_MAX   (ECU_CONFIG_TABLE_2D_32X32_END - ECU_CONFIG_TABLE_2D_32X32_START)
#define ECU_CONFIG_TABLES_2D_16X16_MAX   (ECU_CONFIG_TABLE_2D_16X16_END - ECU_CONFIG_TABLE_2D_16X16_START)
#define ECU_CONFIG_TABLES_2D_8X8_MAX   (ECU_CONFIG_TABLE_2D_8X8_END - ECU_CONFIG_TABLE_2D_8X8_START)

#define ECU_CONFIG_TABLES_1D_32_MAX   (ECU_CONFIG_TABLE_1D_32_END - ECU_CONFIG_TABLE_1D_32_START)
#define ECU_CONFIG_TABLES_1D_16_MAX   (ECU_CONFIG_TABLE_1D_16_END - ECU_CONFIG_TABLE_1D_16_START)
#define ECU_CONFIG_TABLES_1D_8_MAX   (ECU_CONFIG_TABLE_1D_8_END - ECU_CONFIG_TABLE_1D_8_START)
...
typedef struct {
    ecu_config_tables_table_2d_32x32_t tables_2d_32x32[ECU_CONFIG_TABLES_2D_32X32_MAX];
    ecu_config_tables_table_2d_16x16_t tables_2d_16x16[ECU_CONFIG_TABLES_2D_16X16_MAX];
    ecu_config_tables_table_2d_8x8_t tables_2d_8x8[ECU_CONFIG_TABLES_2D_8X8_MAX];

    ecu_config_tables_table_1d_32_t tables_1d_32[ECU_CONFIG_TABLES_1D_32_MAX];
    ecu_config_tables_table_1d_16_t tables_1d_16[ECU_CONFIG_TABLES_1D_16_MAX];
    ecu_config_tables_table_1d_8_t tables_1d_8[ECU_CONFIG_TABLES_1D_8_MAX];
