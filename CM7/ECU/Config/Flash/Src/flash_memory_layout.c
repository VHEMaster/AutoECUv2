...
static const flash_mem_layout_section_info_t flash_mem_layout_sections[] = {
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_IGNPOWER,
        .section_index = ECU_MODULE_IGNPOWER_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 0,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 1,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_2,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 2,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_3,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 3,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_4,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 4,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_5,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 5,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_MODULE_INDICATION,
        .section_index = ECU_MODULE_INDICATION_6,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 9,
        .sector_index = 6,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_COMM_KWP,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_COMM_ISOTP,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_COMM_ISOTP,
        .section_index = ECU_COMM_ISOTP_2,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 10,
        .sector_index = 5,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_COMM_UDS,
    ...
    },
    {
        ...
        .section_index = ECU_COMM_ROUTER_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 10,
        .sector_index = 14,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_TIMING_BASE,
        .section_index = ECU_TIMING_BASE_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 11,
        .sector_index = 0,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_TIMING_IGNITION,
        .section_index = ECU_TIMING_IGNITION_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 11,
        .sector_index = 1,
        .uses_full_block = false,
    ...
    {
        .section_type = FLASH_SECTION_TYPE_TIMING_INJECTION,
        .section_index = ECU_TIMING_INJECTION_1,
        .section_length = ECU_FLASH_SECTOR_SIZE,
        .block_index = 11,
        .sector_index = 2,
        .uses_full_block = false,
