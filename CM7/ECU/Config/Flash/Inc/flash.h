...
typedef enum {
  ...
  FLASH_SECTION_TYPE_SENSOR_CKP,
  FLASH_SECTION_TYPE_SENSOR_CMP,
  FLASH_SECTION_TYPE_SENSOR_ECT,
  FLASH_SECTION_TYPE_SENSOR_EGT,
  FLASH_SECTION_TYPE_SENSOR_IAT,
  FLASH_SECTION_TYPE_SENSOR_MAF,
  FLASH_SECTION_TYPE_SENSOR_MAP,
  FLASH_SECTION_TYPE_SENSOR_TPS,
  FLASH_SECTION_TYPE_SENSOR_VSS,
  FLASH_SECTION_TYPE_SENSOR_APS,
  FLASH_SECTION_TYPE_SENSOR_OTS,
  FLASH_SECTION_TYPE_SENSOR_OPS,

  FLASH_SECTION_TYPE_MODULE_ETC,
  FLASH_SECTION_TYPE_MODULE_VVT,
  FLASH_SECTION_TYPE_MODULE_FUELPUMP,
  FLASH_SECTION_TYPE_MODULE_COOLINGFAN,
  FLASH_SECTION_TYPE_MODULE_IGNPOWER,
  FLASH_SECTION_TYPE_MODULE_INDICATION,
  FLASH_SECTION_TYPE_MODULE_WGCV,

  FLASH_SECTION_TYPE_TIMING_BASE,
  FLASH_SECTION_TYPE_TIMING_IGNITION,
  FLASH_SECTION_TYPE_TIMING_INJECTION,
  FLASH_SECTION_TYPE_TIMING_ROUGH,

  FLASH_SECTION_TYPE_CALIBRATION_IO,
  FLASH_SECTION_TYPE_CALIBRATION_POWERMODING,
  FLASH_SECTION_TYPE_CALIBRATION_CYLINDERS,
  FLASH_SECTION_TYPE_CALIBRATION_CALCDATA,
  FLASH_SECTION_TYPE_CALIBRATION_TABLES,

  FLASH_SECTION_TYPE_RUNTIME_CORRECTIONS,

  FLASH_SECTION_TYPE_COMM_CAN,
  FLASH_SECTION_TYPE_COMM_KWP,
  FLASH_SECTION_TYPE_COMM_ISOTP,
  FLASH_SECTION_TYPE_COMM_UDS,
  FLASH_SECTION_TYPE_COMM_OBD2,
  FLASH_SECTION_TYPE_COMM_ROUTER,
...
typedef enum {
  ...
  FLASH_SECTION_INDEX_4,
  FLASH_SECTION_INDEX_5,
