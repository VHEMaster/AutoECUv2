...
static const ecu_config_banks_t ecu_calibration_banks_config_default = {
    .banks = {
      {
          .sensor_cmp = {
          ...
          .sensor_vss = {
              ECU_SENSOR_NONE, //ECU_CONFIG_BANKS_VSS_PRIMARY
          },
          .sensor_aps = {
              ECU_SENSOR_NONE, //ECU_CONFIG_BANKS_APS_ACCELERATOR
          },
...
error_t ecu_calibration_banks_get_default_config(ecu_calibration_instance_t instance, ecu_config_banks_t *config)
{
  ...
  do {
    ...
    memcpy(config, &ecu_calibration_banks_config_default, sizeof(ecu_config_banks_t));
